...
void initAll()
{
	...
	//FILE *fp;
	if((fp=fopen("/SYS/NetGroup2.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup3.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup4.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup5.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup6.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup7.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup8.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup9.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
	...
	if((fp=fopen("/SYS/NetGroup10.dat", "rb"))==NULL) {
      //printf("Cannot open file.\n");
    }
