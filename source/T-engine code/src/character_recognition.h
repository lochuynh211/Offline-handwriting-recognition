...
void initAll();
char characterRecognitionGroup1(Image* inImage);
char characterRecognitionGroup2(Image* inImage);
char characterRecognitionGroup3(Image* inImage);
char characterRecognitionGroup4(Image* inImage);
char characterRecognitionGroup5(Image* inImage);
char characterRecognitionGroup6(Image* inImage);
char characterRecognitionGroup7(Image* inImage);
char characterRecognitionGroup8(Image* inImage);
char characterRecognitionGroup9(Image* inImage);
