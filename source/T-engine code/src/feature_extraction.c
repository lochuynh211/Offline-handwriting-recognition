...
void getFeatureExtraction(Image* input, double* output, int group)
{
	...
	//////printf("ket qua findingStartingPoint \n");
	//printImage(input);
...
void getMDFFeatureVector(Image* input, double* output, int RESAMPLE_SIZE_HEIGHT, int RESAMPLE_SIZE_WIDTH)
{
	...
	////printf("dividedHeight = %d \n",dividedHeight);
	////printf("dividedWidth = %d \n",dividedHeight);
	////printf("modularHeight = %d \n",dividedHeight);
	////printf("modularWidth = %d \n",dividedHeight);
	*/
	...
	*/
	...
	for (i = 0; i < 2; i++){	//left to right and right to left
		for (j = 0; j < RESAMPLE_SIZE_HEIGHT; j++)
		{
			...
			//if(j==RESAMPLE_SIZE_HEIGHT - 1) ////printf("ket thuc for (j = 0; j < RESAMPLE_SIZE_HEIGHT; j++) \n");
		}
		//////printf("for (i = 0; i < 2; i++) voi i = %d \n", i);
	}
